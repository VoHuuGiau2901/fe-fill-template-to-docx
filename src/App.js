  ...
  return (
    <div>
      ...
      <div className='container right'>
        ...
        <div className='serviceBox' onClick={e => handleClick("WCWDWI")}>
        ...
        <div className='serviceBox' onClick={e => handleClick("WPWL")}>
        ...
        <div className='serviceBox' onClick={e => handleClick("WTWS")}>
